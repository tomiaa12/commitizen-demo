...
```bash
npm install --save-dev husky commitlint @commitlint/config-conventional @tomiaa/git-gz
```

或者使用 yarn：

```bash
yarn add --dev husky commitlint @commitlint/config-conventional @tomiaa/git-gz
```
